...
var g_angleRate1 =  25.0;        // rotation angle rate, degrees/sec
var g_angleMax1  = 360.0;       // max, min allowed angle, in degrees
var g_angleMin1  =  0.0;
                                //---------------
...
var lightPos = {
  ...
  if(g_show1 == 1) { // IF user didn't press HTML button to 'hide' VBO1:
    part1Box.switchToMe(mode,light1,light2,lightPos,ambient,diffuse,specular);  // Set WebGL to render from this VBObox.
	...
	if(g_show2 == 1) { // IF user didn't press HTML button to 'hide' VBO2:
	  part2Box.switchToMe(mode,light1,light2,lightPos,ambient,diffuse,specular);  // Set WebGL to render from this VBObox.
...
function shaderChange() {
  var value = document.getElementById("shading").value;
  if(value == "0"){
    g_show1 = 1;
    g_show2 = 0;
  }
...
function lightChange() {
  var value = document.getElementById("lighting").value;
  if(value == "0"){
    mode = 0.0;
  }
  else if(value == "1"){
...
function lightSwitch1() {
  var value = document.getElementById("light1").value;
  if(value == "0"){
    light1 = 0.0;
  }
  else if(value == "1"){
...
function lightSwitch2() {
  var value = document.getElementById("light2").value;
  if(value == "0"){
    light2 = 0.0;
  }
  else if(value == "1"){
...
function changeAmbient() {
  var red = document.getElementById("ambientRed").value;
  var green = document.getElementById("ambientGreen").value;
  var blue = document.getElementById("ambientBlue").value;
  if(red != "" && !(red-0 > 1.0) && !(red-0 < 0.0)){
    ambient.Red = red;
  }
  if(green != "" && !(green-0 > 1.0) && !(green-0 < 0.0)){
    ambient.Green = green;
  }
  if(blue != "" && !(blue-0 > 1.0) && !(blue-0 < 0.0)){
    ambient.Blue = blue;
  }
  drawAll();
}
...
function changeDiffuse() {
  var red = document.getElementById("diffuseRed").value;
  var green = document.getElementById("diffuseGreen").value;
  var blue = document.getElementById("diffuseBlue").value;
  if(red != "" && !(red-0 > 1.0) && !(red-0 < 0.0)){
    diffuse.Red = red;
  }
  if(green != "" && !(green-0 > 1.0) && !(green-0 < 0.0)){
...
function changeSpecular() {
  var red = document.getElementById("specularRed").value;
  var green = document.getElementById("specularGreen").value;
  var blue = document.getElementById("specularBlue").value;
  if(red != "" && !(red-0 > 1.0) && !(red-0 < 0.0)){
    specular.Red = red;
  }
  if(green != "" && !(green-0 > 1.0) && !(green-0 < 0.0)){
    specular.Green = green;
  }
  if(blue != "" && !(blue-0 > 1.0) && !(blue-0 < 0.0)){
    specular.Blue = blue;
  }
